...
def call_prism_pexpect_sat(filename, str_modchecker):
    ...
    for spec_num in range(1, 3, 1):
        input_fn = [filename, 'spec_sat.pctl', '-prop', f'{spec_num}', '-sim', '-simmethod', 'aci', '-simpathlen', '1000000', '-simsamples', '500000', '-mtbdd', '-exportresults', f'{fn_arr}_{spec_num}.txt:csv']
